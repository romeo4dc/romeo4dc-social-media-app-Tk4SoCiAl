  ...
  return (
    ...
    <span style={{
      ...
      { 
        ...
        return(
          <li className={value === ind ? "rightbarliactive" : undefined} 
          onClick={()=>setValue(ind)} key={ind}>{val}</li>
        )
      })
      }
        </div>
        <div className="users" >
        {
            ...
            activeUsersData.map((users,ind)=>{
                ...
                return(
                    ...
                    <div className="user" key={ind} onClick={()=>router.push(`/MessagesComp/${uid}`)}> 
                <Image 
      ...
      <span style={{
        fontWeight:'600', 
        color:'#808080', 
        marginLeft:'.5em'}}>Requests</span>
      <div className="requests">
        <div className="req">
            <div className="user">
            <Image 
            src={`https://res.cloudinary.com/demo/image/fetch/https://images.pexels.com/photos/428328/pexels-photo-428328.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2`} 
            height={30} 
            width={30} 
            alt="randomImage" />
                <div>
